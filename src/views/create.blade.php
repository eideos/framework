...
<script type="text/javascript">var OP = "A";</script>
...
<div class="row">
    <div class="col-12">
        <form method="post" class="maint" action="{{fmw_action($controller, 'store')}}" enctype="multipart/form-data" data-type="maint">
            @csrf
